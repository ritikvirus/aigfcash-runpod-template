...
wget -c https://gist.githubusercontent.com/padeoe/697678ab8e528b85a2a7bddafea1fa4f/raw/3ed815fdcef9a30bd985772ab95ca57801c80bfa/hfd.sh
git clone https://github.com/CY-CHENYUE/ComfyUI-Janus-Pro custom_nodes/ComfyUI-Janus-Pro
pip install -r custom_nodes/ComfyUI-Janus-Pro/requirements.txt
mkdir models/Janus-Pro
#download entire Janus-Pro HuggingFace to ComfyUI/models/Janus-Pro folder
bash hfd.sh deepseek-ai/Janus-Pro-7B -x 8 -j 3 --local-dir models/Janus-Pro
